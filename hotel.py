...
class HotelManagementSystem:
    def __init__(self, root):
        ...
        #*************** 1st image ***************
        img1 = Image.open(r"images\taj.jpg")
        ...
        details_btn = Button(btn_frame,command=self.detailsroom, text="DETAILS",width=22, font=("times new roman", 14, "bold     "), bg="black", fg="gold", bd=0,cursor="hand1")
        ...
        logout_btn = Button(btn_frame,command=self.logout, text="LOGOUT",width=22, font=("times new roman", 14, "bold     "), bg="black", fg="gold", bd=0,cursor="hand1")
        logout_btn.grid(row=4, column=0,pady=1)


        # *******************right side  image********************
        img3 = Image.open(r"images\mainbg.jpg")
